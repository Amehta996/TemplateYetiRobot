...
public final class Constants
{
    ...
    public static final int LEFT_DRIVE_TALON_3 = 6;
    public static final int LEFT_DRIVE_TALON_4 = 7;
    public static final int RIGHT_DRIVE_TALON_1 = 2;
    public static final int RIGHT_DRIVE_TALON_2 = 3;
    public static final int RIGHT_DRIVE_TALON_3 = 5;
    public static final int RIGHT_DRIVE_TALON_4 = 4;
    public static final int INTAKE_TALON = 9;

    public static final int PIGEON = 0;

    public static final double GEAR_RATIO = 5; //placeholder
    ...
    public static final int SHOOTER_MOTOR_2 = 11;

    public static final int SHOOTER_DIAMATER = 4;
